...
| ---------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| [House Price Prediction](https://github.com/martynov-dm/mfdp-experiments)                            | Price prediction app for Russian housing market [Demo](https://mfdp-frontend-martynov-dm.amvera.io/predict) | EDA, Data Preprocessing, Feature Engineering (Juputer Notebooks), AutoML, FastAPI, Docker, React.js |
