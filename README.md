...
| -------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| [House Price Prediction](https://github.com/martynov-dm/mfdp-api)                                                          | Price prediction app for Russian housing market                                                                                                                                                                 | EDA, Data Preprocessing, Feature Engineering (Juputer Notebooks), AutoML, FastAPI, Docker, React.js |
...
| [Recommendation System for Social Media Posts](https://github.com/ValentinPatrakeev/Recommendation-system-social-network/) | This project implements a content-based recommendation system for social media posts using NLP to extract topics from text. It matches user interests with post themes to provide personalized recommendations. | Feature Engineering, Transformers/Roberta, Catboost, FastAPI                                        |
